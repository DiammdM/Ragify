...
const translations = {
  en: {
    ...
    chat: {
      ...
      historyEmpty: "No chat history yet. Start a new conversation.",
      loadingHistory: "Loading conversation history...",
      loadHistoryError: "Unable to load chat history right now.",
  ...
  zh: {
    ...
    chat: {
      ...
      historyTitle: "历史会话",
      historyEmpty: "还没有历史会话，先新建一个对话吧。",
      loadingHistory: "正在加载历史会话...",
      loadHistoryError: "暂时无法加载聊天历史，请稍后重试。",
