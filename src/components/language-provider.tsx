...
const translations = {
  en: {
    ...
    qa: {
      ...
      processing: 'Synthesizing answer...',
      mockAnswer:
        'This is a simulated answer. Connect your preferred model to see live responses powered by your indexed knowledge.',
      mockSourcesTitle: 'Source chunks',
      mockSources: ['Onboarding Guide — Section 2', 'Pricing FAQ — Paragraph 5'],
      quickQuestions: [
  ...
  zh: {
    ...
    qa: {
      ...
      processing: '正在生成回答...',
      mockAnswer:
        '这里展示的是模拟回答。接入您选择的模型后，将根据索引内容输出真实答案。',
      mockSourcesTitle: '引用分片',
      mockSources: ['新客户上手指南 — 第 2 节', '价格常见问题 — 第 5 段'],
      quickQuestions: [
        '新客户需要完成哪些上手步骤？',
        '请概述企业协议的关键条款。',
        '如何升级 P1 级别的支持工单？',
